...
int UILocalSpatialAudioEngine::Initialize(FLocalSpatialAudioConfig config)
{
	...
	GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::White, TEXT("THIS IS A LOCAL SPATIAL AUDIO MESSAGE"));
	return -ERROR_NULLPTR;
}
int UILocalSpatialAudioEngine::UpdateRemotePosition(int64 uid, FRemoteVoicePositionInfo posInfo, FRemoteVoicePositionInfo& outPosInfo)
{
	...
	outPosInfo.position.X = remoteVoicePositionInfo.position[0];
	outPosInfo.position.Y = remoteVoicePositionInfo.position[1];
	outPosInfo.position.Z = remoteVoicePositionInfo.position[2];
	outPosInfo.forward.X = remoteVoicePositionInfo.forward[0];
	outPosInfo.forward.Y = remoteVoicePositionInfo.forward[1];
	outPosInfo.forward.Z = remoteVoicePositionInfo.forward[2];
